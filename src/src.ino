...
int rightMatrixRowPins[8] = {30,31,32,33,34,35,36,37};
int rightMatrixColumnPins[8] = {40,41,42,43,44,45,46,47};

NoDriverMatrix rightMatrix(rightMatrixRowPins, rightMatrixColumnPins);

LedControl leftMatrix(11, 13, 10, 1);
